...
public class IncommingScreen extends BaseActivity {

    static final String TAG = IncommingScreen.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_incomming_screen);
