...
import com.example.vietvan.lapitchat.phonecall.AudioPlayer;
...
public class Video_CallScreen extends BaseActivity {

    static final String TAG = Video_CallScreen.class.getSimpleName();
    ...
    private class UpdateCallDurationTask extends TimerTask {
        ...
        @Override
        public void run() {
            Video_CallScreen.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    updateCallDuration();
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video__call_screen);
    ...
    private class SinchCallListener implements VideoCallListener {
        ...
        public void onCallEnded(Call call) {
            ...
            Toast.makeText(Video_CallScreen.this, endMsg, Toast.LENGTH_LONG).show();
